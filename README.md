...
## Installation
You can install Pat using one of the following methods:

### Using Pip
1. Ensure you have Python installed (version 3.6 or greater).
...
1. Clone the repository:
   ```bash
   git clone https://github.com/type1arc/pat.git
   ```
2. Navigate into the directory:
   ```bash
   cd pat
   ```
3. For Python installations, run:
   ```bash
